...
-- Generated: 2026-03-13T23:53:08.666Z
...
hipoglicemiantes orales y bueno esa fue esta clase nos vemos los siguientes vídeos que estén bien',
    'Comenzamos esta serie sobre diabetes con el tema más importante para ordenar el resto del módulo: la clasificación de los tipos de diabetes mellitus. Una aclaración inicial que evita confusiones frecuentes: cuando hablamos de diabetes en este módulo, nos referimos exclusivamente a diabetes mellitus. La diabetes insípida es una patología completamente distinta, de origen hipofisario o renal, y se aborda en el módulo de endocrinología general.

El primer tipo que deben conocer es la **diabetes mellitus tipo 1**. Representa solo el 10% de todos los casos, pero es la forma más dramática en su presentación. El mecanismo es autoinmune: el propio sistema inmune destruye progresivamente las células beta de los islotes de Langerhans en el páncreas, que son las únicas capaces de secretar insulina. Sin insulina, el organismo no puede utilizar la glucosa como fuente energética y entra en crisis metabólica. Predomina en niños y adolescentes, aunque puede aparecer a cualquier edad, y su debut suele ser brusco y severo.

El segundo tipo, y con diferencia el más frecuente, es la **diabetes mellitus tipo 2**. Aquí el páncreas inicialmente funciona bien, pero los tejidos periféricos —músculo, hígado, tejido adiposo— se vuelven resistentes a la acción de la insulina. Esta resistencia obliga al páncreas a secretar cada vez más insulina para mantener la glicemia normal. Con el tiempo, el páncreas se agota y no logra compensar la resistencia, instalándose la hiperglicemia crónica. La obesidad es el principal motor fisiopatológico: el exceso de ácidos grasos libres y adipoquinas proinflamatorias generan y amplifican esa resistencia. Es la forma que encontrarán en la gran mayoría de sus pacientes adultos.',
    ...
    '[]'::jsonb,
    '[{"pregunta":"¿Cuál de los siguientes hallazgos orientaría más fuertemente hacia un diagnóstico de diabetes MODY en un paciente joven?\nA) Debut con cetoacidosis diabética a los 17 años y ausencia de antecedentes familiares de diabetes.\nB) Diabetes diagnosticada a los 22 años en una persona normopeso, con madre y abuelo materno diabéticos diagnosticados antes de los 30 años, también sin obesidad.\nC) Adulto de 35 años que no responde a metformina en dosis máxima, con antecedente de vitíligo.\nD) Niño de 8 años con polidipsia, poliuria y glicemia de 450 mg/dL, sin antecedentes familiares.\nE) Paciente con síndrome de Cushing y glicemia en ayuno de 135 mg/dL en tratamiento con corticoides.","respuesta":"Respuesta correcta: B — La MODY se caracteriza por herencia autosómica dominante (la enfermedad aparece en múltiples generaciones sin saltar ninguna), debut en personas jóvenes y normopeso, y ausencia de obesidad o síndrome metabólico. La opción A describe una presentación clásica de DM tipo 1. La opción C orienta a LADA (adulto, autoinmunidad, resistencia a orales). La opción D es una presentación típica de DM tipo 1 en niño. La opción E es diabetes secundaria a corticoides."},{"pregunta":"¿Un hombre de 38 años, IMC 22, es derivado por fracaso a metformina en dosis máxima luego de 18 meses de tratamiento. Tiene antecedente de hipotiroidismo autoinmune. ¿Cuál es el diagnóstico más probable y qué exámenes confirmarían la sospecha?\nA) Diabetes mellitus tipo 2 mal adherente al tratamiento; solicitar HbA1c y fondo de ojo.\nB) Diabetes MODY; solicitar estudio genético de mutaciones monogénicas.\nC) Diabetes LADA; solicitar péptido C (esperado bajo) y anticuerpos anti-GAD, anti-insulina, anti-IA2.\nD) Diabetes inducida por hipotiroidismo; tratar el hipotiroidismo y reevaluar sin cambiar el esquema.\nE) Diabetes tipo 1 de inicio tardío sin necesidad de estudios adicionales; iniciar insulina empíricamente.","respuesta":"Respuesta correcta: C — El perfil de adulto joven normopeso con otra enfermedad autoinmune y fracaso a hipoglicemiantes orales es el patrón clásico de LADA. El péptido C bajo confirmaría la destrucción de células beta, y los anticuerpos confirmarían la etiología autoinmune. La MODY (opción B) tiene patrón familiar dominante, no autoinmunidad. La opción D es incorrecta porque el hipotiroidismo eleva el LDL, no produce diabetes de base."},{"pregunta":"¿Cuál de las siguientes afirmaciones sobre el péptido C es correcta en el contexto de la clasificación de los tipos de diabetes?\nA) El péptido C estará elevado en un paciente con diabetes tipo 1 de larga data porque el páncreas compensa la resistencia periférica hipersecretando insulina.\nB) El péptido C bajo en un paciente con diabetes indica necesariamente que recibe insulina exógena.\nC) Un péptido C elevado en un paciente con diabetes orienta hacia formas con reserva pancreática preservada, como la DM tipo 2 o la MODY, y hace menos probable una etiología autoinmune.\nD) El péptido C es un marcador de autoinmunidad y su positividad confirma diabetes LADA.\nE) El péptido C no tiene utilidad clínica porque sus valores se superponen entre todos los tipos de diabetes.","respuesta":"Respuesta correcta: C — El péptido C mide la secreción endógena de insulina. Estará elevado cuando el páncreas hipersecreta (DM tipo 2 con resistencia insulínica, MODY) y disminuido cuando hay destrucción de células beta (DM tipo 1, LADA) o daño pancreático estructural. No es marcador de autoinmunidad (eso son los anticuerpos anti-GAD, anti-IA2, etc.), y tampoco confirma por sí solo la presencia de insulina exógena, aunque sí orienta hacia ella cuando está bajo junto a insulina elevada."}]'::jsonb,
    NOW(),
    TRUE,
...
Así que nos vemos en los siguientes videos.',
    'Diagnosticar diabetes no es complicado si tienen claro el esquema, pero hay varios detalles que el EUNACOM suele aprovechar para confundir. Así que vamos paso a paso.

Lo primero que deben tener grabado: los criterios diagnósticos solo me dicen si hay o no hay diabetes mellitus. No me dicen qué tipo es. Para saber si estamos frente a una diabetes tipo 1, una tipo 2, una LADA o una MODY, necesito la clínica completa, la edad del paciente, su contexto, y eventualmente los anticuerpos. Los criterios son solo la confirmación de que existe la enfermedad. Nunca los confundan con la clasificación del tipo.

Dicho eso, veamos los tres criterios diagnósticos que deben saberse de memoria.',
...
los pacientes con diabetes y embarazo que estén muy bien',
    'El diagnóstico de diabetes en el embarazo es uno de los temas que más errores genera en el EUNACOM. El problema no es que sea difícil de entender, sino que los criterios cambian significativamente respecto a los de una persona no embarazada, y en el examen les suelen mezclar los dos contextos deliberadamente para ver si los distinguen. Por eso, cada vez que vean una pregunta sobre glicemia y diabetes, lo primero que deben preguntarse es: ¿está embarazada la paciente? Y si lo está, ¿en qué semana de gestación se encuentra? Esa respuesta determina todo lo que viene después.

Partamos por la **diabetes mellitus gestacional**. Es la diabetes que se diagnostica durante el embarazo y que no existía antes. Para diagnosticarla se utilizan criterios más estrictos que en la población general. El primero: dos glicemias de ayuno iguales o mayores a 100 mg/dL. Noten la diferencia con el criterio general, que es 126. En el embarazo el umbral cae a 100. El segundo criterio es un TTGO con 75 gramos en el que la glicemia basal sea igual o mayor a 100, o bien que la glicemia a las dos horas post-carga sea igual o mayor a 140 mg/dL. El tercer criterio es idéntico al de la población general: una glicemia igual o mayor a 200 mg/dL acompañada de síntomas clásicos de diabetes, aunque este escenario es bastante infrecuente en la diabetes gestacional.

Acá viene el concepto más importante de esta cápsula y el que con mayor frecuencia se pregunta en el EUNACOM: **en el embarazo no existe la prediabetes**. No hay glicemia de ayuno alterada. No hay intolerancia a la glucosa oral. Si los valores llegan a esos umbrales, el diagnóstico es directamente diabetes mellitus gestacional. ¿Por qué el embarazo es tan estricto? Porque con niveles de glicemia que en un adulto no embarazado serían solo "preocupantes", el feto ya puede desarrollar complicaciones graves: macrosomía, hipoglicemia neonatal, sufrimiento fetal. El feto no tolera la zona gris.',
...
vamos a ir viendo los ajustes que va a quedar un poquito más claro que estén bien',
    'La insulinoterapia puede parecer intimidante cuando uno ve la cantidad de nombres y tipos de insulina que existen, pero si entienden la lógica cinética de cada una, todo encaja. Vamos a revisar los tipos de insulina, sus características y los esquemas en que se usan, tanto en el manejo ambulatorio como en el paciente hospitalizado.

Empezamos con la **insulina cristalina**, también conocida como insulina regular o insulina común. Es la más clásica, la que existe hace décadas. Tiene inicio de acción a los 30 minutos de administrada, su peak de actividad ocurre entre la hora y media y las tres horas y media, y su efecto total dura alrededor de 6 a 8 horas. Se administra por vía subcutánea antes de las comidas: el paciente tiene que comer después de aplicarla para no hacer una hipoglicemia. Es económica, disponible en todos los centros de salud y efectiva. Es la insulina rápida de referencia en Chile.

La **insulina NPH** es una insulina de acción intermedia, formulada con protamina, que hace que se absorba y libere de forma más lenta. Su efecto dura aproximadamente 12 horas y su peak ocurre entre las 4 y 6 horas post-administración. La NPH tiene una ventaja práctica importante: puede mezclarse en la misma jeringa con insulina cristalina, e incluso con algunas insulinas ultrarápidas. Cuando se mezclan, la regla es cargar primero la NPH y luego la cristalina, y aplicar de inmediato. Por durar 12 horas, puede usarse una o dos veces al día según el esquema.',
    ...
    '[]'::jsonb,
    '[{"pregunta":"¿Cuál de las siguientes afirmaciones describe correctamente las características cinéticas de los tipos de insulina?\nA) La insulina cristalina inicia su acción a los 15 minutos y su peak ocurre entre 30 y 60 minutos, lo que permite administrarla junto a la comida.\nB) La insulina NPH dura 24 horas sin peak de acción, lo que la hace equivalente a la glargina para el manejo basal.\nC) La insulina glargina tiene un peak de acción entre las 4 y 6 horas similar a la NPH, pero de mayor duración.\nD) La insulina cristalina tiene inicio de acción a los 30 minutos, peak entre 1,5 y 3,5 horas, y duración de 6-8 horas; debe administrarse antes de las comidas.\nE) Las insulinas ultrarápidas son idénticas a la cristalina en su perfil cinético y se usan exclusivamente en pacientes hospitalizados.","respuesta":"Respuesta correcta: D — La insulina cristalina inicia a los 30 minutos (no 15), con peak a 1,5-3,5 horas y duración de 6-8 horas, por lo que debe administrarse antes de comer. La NPH dura 12 horas (no 24) con peak a 4-6 horas. La glargina dura 24 horas sin peak (no tiene peak a 4-6 horas). Las ultrarápidas (inicio 15-30 min) sí difieren de la cristalina en su cinética más rápida."}]'::jsonb,
    NOW(),
    TRUE,
...
insulina. Que estén bien.',
    'Ajustar la insulinoterapia es una de las competencias que el EUNACOM evalúa con mayor frecuencia en el área de diabetes, y es también una de las más útiles en la práctica real como médico general. La buena noticia es que no hay que memorizar cada situación posible por separado: hay una lógica que las unifica todas. Si entienden esa lógica, el resto se deduce solo.

El principio de partida es simple. Cuando el paciente hace hipoglicemias, hay que reducir la insulina o agregarle una colación en el momento en que ocurre la hipoglicemia. Cuando el control metabólico es insuficiente, medido principalmente por la hemoglobina glicosilada elevada, hay que subir la insulina o reducir el aporte calórico. El costo de un buen control metabólico siempre implica un balance entre evitar la hiperglicemia y no generar hipoglicemias ni alza de peso excesiva.

La clave para saber qué ajustar es entender qué determina cada glicemia. Hay que dividir el mundo de las insulinas en dos grupos: las **insulinas lentas** —NPH y ultralentas como la glargina— que determinan las **glicemias preprandiales**, y las **insulinas rápidas** —cristalina y ultrarápidas— que determinan las **glicemias postprandiales**.',
...
que estén bien',
    'Cuando manejamos a un paciente diabético, no basta con prescribir medicamentos. Hay que saber hacia dónde vamos: cuáles son las metas concretas que perseguimos y cómo sabemos si las estamos alcanzando. Esta cápsula es sobre eso, sobre los objetivos del manejo de la diabetes mellitus.

El objetivo clínico de fondo es siempre el mismo: evitar las complicaciones. Las **complicaciones agudas** —cetoacidosis diabética, síndrome hiperglicémico hiperosmolar e hipoglicemia— pueden poner en riesgo la vida en horas. Las **complicaciones crónicas** —retinopatía, nefropatía, neuropatía periférica, pie diabético y la enfermedad cardiovascular acelerada— se instalan en años y son responsables de la mayor carga de morbilidad y mortalidad que tiene esta enfermedad. Todas se previenen o se retardan con un control metabólico sostenido.

La herramienta principal para medir ese control metabólico es la **hemoglobina glicosilada**, la HbA1c. El objetivo estándar para la mayoría de los pacientes diabéticos es mantenerla **por debajo del 7%**. Los estudios clínicos demuestran que bajo ese umbral las complicaciones crónicas son infrecuentes y las agudas son raras, con la excepción de la hipoglicemia, que es el precio inherente de un control estricto. La HbA1c se pide cada tres meses mientras el paciente está siendo ajustado en su tratamiento o no ha alcanzado la meta. Cuando ya logra niveles estables dentro del objetivo, puede espaciarse a cada seis meses.',
    ...
    '["El objetivo principal del tratamiento es prevenir complicaciones agudas (cetoacidosis, hipoglicemia) y crónicas (retinopatía, nefropatía, neuropatía, pie diabético).","La HbA1c debe mantenerse < 7% en la mayoría de los pacientes; se acepta < 8% en pacientes con hipoglicemias frecuentes, niños pequeños, expectativa de vida < 10 años o mayores de 75 años.","La HbA1c se solicita cada 3 meses hasta lograr estabilidad; puede espaciarse a 6 meses con control sostenido. En caso de discordancia con glicemias individuales, manda la HbA1c."]'::jsonb,
    '[]'::jsonb,
    '[{"pregunta":"¿En cuál de los siguientes pacientes diabéticos se acepta un objetivo de HbA1c de < 8% en lugar del objetivo estándar de < 7%?\nA) Un hombre de 45 años con diabetes tipo 2 de 3 años de evolución, activo laboralmente, sin complicaciones.\nB) Una mujer de 60 años con nefropatía diabética incipiente y presión arterial mal controlada.\nC) Un hombre de 78 años con episodios frecuentes de hipoglicemia severa y expectativa de vida reducida por insuficiencia cardíaca avanzada.\nD) Un paciente de 50 años con retinopatía diabética proliferativa en tratamiento con láser.\nE) Un paciente con diabetes tipo 1 de 30 años de evolución con buen control previo.","respuesta":"Respuesta correcta: C — Se acepta objetivo de HbA1c < 8% (en lugar de < 7%) en cuatro situaciones: hipoglicemias frecuentes o severas, niños pequeños, expectativa de vida < 10 años, y pacientes mayores de 75 años. El paciente de 78 años cumple múltiples criterios: edad > 75, hipoglicemias frecuentes y comorbilidad grave. Las demás opciones corresponden a pacientes que se benefician del control estricto < 7%."}]'::jsonb,
    NOW(),
    TRUE,
    FALSE  -- first 3 free preview
  ) ON CONFLICT (specialty_id, order_index)
...
pacientes ahora lo más difícil es convencerlo que se tomen los remedios que estén bien',
    'Cuando hablamos de hipoglicemiantes orales, estamos hablando de fármacos exclusivos para la diabetes mellitus tipo 2. Esto es lo primero que deben tener absolutamente claro: en la diabetes tipo 1 y en todas las formas autoinmunes, estos medicamentos no sirven para nada. El páncreas autoinmune no tiene células beta funcionantes que estimular. Solo en la diabetes tipo 2, donde hay resistencia a la insulina con un páncreas que aún produce algo, estos fármacos pueden actuar.

En esta cápsula vamos a recorrer todas las familias de hipoglicemiantes orales: quiénes son, cómo funcionan y cuándo elegir cada uno. Empecemos por el más importante de todos.

Las **biguanidas** tienen un único representante que importa: la **metformina**. Su mecanismo es aumentar la sensibilidad a la insulina en los tejidos periféricos, reduciendo así la resistencia insulínica. Imagínense que el receptor de insulina en el músculo o en el hígado está como atascado, y la metformina viene a soltar ese candado. En términos prácticos: es barata, es eficaz, lleva décadas de uso y prácticamente no produce hipoglicemia. Sus efectos adversos son casi siempre gastrointestinales —diarrea, náuseas, malestar abdominal— y suelen mejorar si se inicia con dosis bajas o si se usa la formulación de liberación prolongada, la metformina XR. Tiene dos contraindicaciones que deben memorizar: insuficiencia renal con creatinina igual o mayor a 1,5 mg/dL o clearance menor a 30 mL/min, e insuficiencia cardíaca moderada a severa. La razón es que en ambas condiciones puede acumularse y producir acidosis láctica, que es una complicación grave. Esas dos contraindicaciones son las que aparecen en el EUNACOM.',
...
paciente diabético así que aprendérselo que estén bien',
    'En esta cápsula integramos todo lo aprendido sobre hipoglicemiantes e insulina y lo convertimos en un algoritmo de decisiones clínicas concreto. Saber qué fármacos existen no es suficiente: hay que saber cuándo usarlos, en qué orden, a qué dosis y qué hacer cuando el paciente tiene condiciones especiales.

El **primer escalón** es siempre el mismo: cambio de estilo de vida más inicio de metformina desde el momento del diagnóstico. El cambio de vida incluye dieta saludable, actividad física regular, dejar de fumar y reducción de peso si hay sobrepeso u obesidad. Y junto con eso, metformina de entrada. ¿Hay excepciones? Sí, una muy acotada: si el paciente tiene una diabetes muy leve —hemoglobina glicosilada apenas sobre el límite— y está genuinamente dispuesto a modificar su estilo de vida de forma radical, se puede intentar tres meses solo con cambios. Pero esto es la excepción. La regla es metformina desde el día uno.

Si la hemoglobina glicosilada no baja al objetivo con la dosis inicial, el **segundo escalón** es subir la dosis de metformina. La dosis máxima es 3 gramos diarios —habitualmente 1 gramo cada 8 horas—. Entre 2 y 3 gramos la diferencia de eficacia es pequeña, así que si el paciente ya está con más de 2 gramos y sigue fuera del objetivo, el paso lógico es agregar un segundo fármaco.',
...
la diabetes gestacional. Que estén bien.',
    'Cuando una mujer diabética se embaraza —o cuando el embarazo revela una diabetes que estaba latente— el manejo cambia en aspectos importantes. Las metas son más estrictas, el arsenal terapéutico se acota y el ritmo de las decisiones es más frecuente, porque el tiempo que tiene el feto para crecer no espera. En esta cápsula revisamos el control glucémico en el embarazo: los objetivos, el monitoreo y el tratamiento.

Empecemos por los **objetivos glucémicos**. Fuera del embarazo, aceptamos glicemias preprandiales hasta 130 mg/dL y postprandiales hasta 180 mg/dL en la mayoría de los pacientes. En el embarazo esos rangos son inaceptables. Las metas son bastante más estrictas: preprandiales menores a 90 mg/dL, y postprandiales menores a 120 mg/dL. Así de exigente. La razón es que el feto vive en el mismo ambiente glucémico que la madre: si la madre tiene glicemias de 150 mg/dL después de comer todos los días, el feto también está expuesto, y eso tiene consecuencias reales: macrosomía, hipoglicemia neonatal, polihidramnios. Por eso no hay margen para la permisividad.

Para ilustrarlo: imaginen una paciente de 30 años que se diagnóstica con diabetes gestacional en la semana 26. Sus hemoglucotest postprandiales están entre 130 y 150 mg/dL con dieta. ¿Eso está bien? No: está por encima del objetivo de 120 mg/dL. Hay que actuar.',
...
que no tenga una diabetes 2 de base y bueno eso fue todo nos vemos en los siguientes vídeos',
    'La diabetes en el embarazo no es solo un problema de glicemias: es una condición que afecta al organismo fetal de formas múltiples y que exige al médico conocer bien las complicaciones posibles para anticiparlas. En esta cápsula repasamos el espectro de riesgos asociados a la diabetes gestacional y pregestacional, y los puntos clave del manejo obstétrico.

Empecemos con la complicación más conocida: la **macrosomía fetal**. La hiperglicemia materna atraviesa la placenta, estimula la producción de insulina fetal —que actúa como hormona de crecimiento en el feto— y produce un bebé grande, con peso mayor a 4,5 kilos. Un feto macrosómico complica el parto vaginal y aumenta el riesgo de distocia de hombros. Imaginen a una paciente con diabetes gestacional mal controlada que llega a las 39 semanas con un feto de 4,7 kilos: esa situación requiere cesárea electiva.

La **hipoglicemia neonatal** es el riesgo metabólico más importante del recién nacido hijo de madre diabética. El mecanismo es paradójico pero lógico: el páncreas fetal ha estado sobreestimulado durante el embarazo, secretando grandes cantidades de insulina para compensar la glucosa que venía de la madre. Al nacer y cortar el cordón, desaparece el aporte de glucosa materno, pero la insulina fetal sigue elevada por un tiempo. Eso produce una caída brusca de la glicemia neonatal, cuyo punto más bajo —el nadir— se alcanza habitualmente a las dos horas de vida. Por eso, en todo recién nacido hijo de madre diabética se solicita una glicemia a las dos horas de vida, y antes si hay síntomas como temblores, palidez o letargia.',
...
Y bueno eso fue todo nos vemos en la siguiente clase que estén bien.',
    'En esta cápsula integramos todas las indicaciones de insulina en una sola visión ordenada. Esto es clave para el EUNACOM: no solo deben saber cuándo indicar insulina, sino también con qué esquema, en qué dosis y en el contexto de qué condición clínica. Veamos indicación por indicación.

La primera y más clara es la **diabetes mellitus tipo 1 y la diabetes LADA**. Ambas son enfermedades autoinmunes que destruyen progresivamente las células beta del páncreas. Sin células beta, no hay producción de insulina propia, y sin insulina propia los hipoglicemiantes orales no pueden funcionar —todos actúan estimulando un páncreas que ya no responde o reduciendo la resistencia a una insulina que no existe. La insulina es el único tratamiento posible. El esquema es el intensificado: una insulina basal de acción prolongada —preferentemente glargina— más insulina cristalina antes de cada comida principal. Un paciente tipo 1 de 25 años, recién diagnosticado, con glicemias en 350 mg/dL y cetosis: no se le da metformina. Se le inicia glargina nocturna más cristalina preprandial.

La segunda indicación son las **emergencias hiperglicémicas agudas graves**: la cetoacidosis diabética y el síndrome hiperglicémico hiperosmolar. En ambas la vía es endovenosa: bolo inicial de insulina cristalina —habitualmente 10 unidades o 0,1 unidades por kilogramo de peso— seguido de goteo continuo a la misma dosis por hora hasta estabilizar la glicemia y resolver la crisis. En una emergencia hiperglicémica no se usa NPH: es cristalina endovenosa.',
...
las pruebas que estén bien.',
    'Esta cápsula es de integración. Vamos a aplicar todo lo aprendido sobre el tratamiento de la diabetes tipo 2 a través de una serie de casos clínicos diseñados al estilo del EUNACOM. El objetivo es entrenar el razonamiento clínico: identificar qué variable importa en cada escenario y tomar la decisión correcta sin dudar.

Antes de empezar, recuerden los tres ejes que guían cada decisión: el nivel de HbA1c y el objetivo según la edad del paciente, los factores de riesgo individuales —hipoglicemia, falla renal, falla cardíaca, enfermedad cardiovascular—, y la posición en el algoritmo terapéutico. Con eso en mente, partamos.

**Caso 1.** Mujer de 61 años, metformina 850 mg cada 12 horas, HbA1c de 7,8%. ¿Qué hacemos? A los 61 años el objetivo es menos de 7%. La metformina está en 850 cada 12, que son 1.700 mg al día, y la dosis máxima son 3 gramos. Hay margen para subir. La conducta correcta es aumentar la dosis de metformina antes de agregar un segundo hipoglicemiante.',
...
Así que eso, que estén bien.',
    'En esta cápsula revisamos el manejo de la hipertensión arterial en el paciente diabético. Es un tema que aparece con frecuencia en el EUNACOM y que además sirve como repaso general de los antihipertensivos, sus efectos metabólicos y sus indicaciones específicas. Vale la pena tenerlo bien ordenado.

Partamos con el objetivo de presión arterial. Hay dos cifras que coexisten en la literatura: 130 sobre 80, que es la meta más aceptada internacionalmente, y 140 sobre 90, que algunos documentos nacionales han mencionado. Si en el examen los obligan a elegir, quédense con 130 sobre 80. Ahora bien, cuando el diabético ya tiene nefropatía, ya sea microalbuminuria, macroalbuminuria o caída del clearance de creatinina, esa meta de 130 sobre 80 se vuelve absolutamente obligatoria. No hay margen de discusión.

Imaginemos a don Rodrigo, un hombre de 64 años con diabetes tipo 2 de quince años de evolución, que llega al control de rutina con una presión de 148 sobre 92. Le pedimos un examen de orina y el resultado muestra macroalbuminuria. Aquí ya no existe la opción del 140 sobre 90. La meta es 130 sobre 80, y la elección del antihipertensivo no es arbitraria: importa mucho qué le dejamos.',
...
su respectiva biopsia que esté muy bien',
    'Hablemos de la nefropatía diabética, que es una de las complicaciones crónicas más relevantes de la diabetes y una causa muy importante de enfermedad renal crónica en nuestro país. Este tema hay que tenerlo bien dominado para el EUNACOM.

Partamos por la definición. Nefropatía diabética es el compromiso renal en un paciente diabético. Ese compromiso puede manifestarse de dos formas: como albuminuria o como una caída del clearance de creatinina. Cuando solo hay albuminuria y la función renal aún está preservada, hablamos de nefropatía diabética incipiente o inicial. Cuando ya hay una caída real del filtrado glomerular, hablamos de nefropatía diabética establecida.

Veamos cómo se diagnostica. La albuminuria se clasifica en tres rangos que deben memorizar: menos de 30 miligramos por día es normal; entre 30 y 300 es microalbuminuria; y más de 300 es macroalbuminuria. Cuando la proteinuria total supera los 3 gramos al día, estamos ante una proteinuria en rango nefrótico, que ya implica una situación diferente, y lo vemos más adelante.',
    ...
    '[]'::jsonb,
    '[{"pregunta":"¿Cuál de los siguientes valores del índice de albuminuria-creatininuria (RAC) en muestra aislada de orina corresponde al diagnóstico de microalbuminuria?\nA) RAC > 10 mg/g, porque cualquier pérdida de albúmina sobre lo normal indica daño renal precoz.\nB) RAC > 30 mg/g, que equivale a una pérdida de albúmina entre 30 y 300 mg/día.\nC) RAC > 300 mg/g, que corresponde al umbral de macroalbuminuria y es cuando se trata la nefropatía.\nD) RAC > 3 mg/g, porque en el diabético cualquier pérdida de albúmina es patológica.\nE) RAC > 150 mg/g, porque ese es el valor que corresponde al punto intermedio entre micro y macroalbuminuria.","respuesta":"Respuesta correcta: B — La microalbuminuria se define por pérdida de albúmina entre 30 y 300 mg/día. El RAC en muestra aislada mayor a 30 mg/g es el método actualmente recomendado para su diagnóstico por ser práctico y reproducible. Por debajo de 30 es normal. Sobre 300 mg/g (o mg/día) ya es macroalbuminuria. Sobre 3.000 mg/día (3 g/día) corresponde a proteinuria en rango nefrótico, que obliga a sospechar otra causa (glomerulopatía membranosa)."},{"pregunta":"¿Cuál es el pilar de tratamiento más importante para frenar la progresión de la nefropatía diabética, y cuál es el fármaco de elección para reducir la proteinuria?\nA) El control glucémico estricto (HbA1c < 7%) es el único pilar; los fármacos antihipertensivos no tienen efecto específico sobre la proteinuria.\nB) El control de la presión arterial (meta < 130/80 mmHg) es más importante que el control glucémico para frenar la progresión; los IECA o ARA-2 son de elección por su efecto antiproteinúrico.\nC) La restricción proteica en la dieta es el tratamiento más efectivo para reducir la proteinuria; los fármacos son complementarios.\nD) El Amlodipino es el fármaco de elección porque es el bloqueador del calcio con mayor efecto antiproteinúrico demostrado.\nE) La combinación de IECA + ARA-2 es el estándar de oro para reducir la proteinuria, con mayor eficacia que cualquiera de los dos solos.","respuesta":"Respuesta correcta: B — En la nefropatía diabética, el control de la presión arterial tiene mayor impacto sobre la progresión que el control glucémico. Los IECA (enalapril) o ARA-2 (losartán) son los fármacos de primera línea por su doble efecto: reducen la presión y la proteinuria. La combinación IECA + ARA-2 (opción E) no se recomienda porque aumenta la hiperpotasemia sin beneficio clínico adicional. El Amlodipino (opción D) es neutro en la proteinuria; el complemento antiproteinúrico es el Diltiazem."}]'::jsonb,
    NOW(),
    TRUE,
    FALSE  -- first 3 free preview
  ) ON CONFLICT (specialty_id, order_index)
...
esa fue esta clase algo complicado pero no tanto así que esperamos que haya quedado clara que estén bien',
    'Hablemos de la retinopatía diabética. Es una de las complicaciones crónicas más temidas de la diabetes, y hay buenas razones para eso: es una de las causas más frecuentes de ceguera en adultos. Dependiendo de la fuente que consulten, figura como la primera o segunda causa de ceguera irreversible, por detrás únicamente de las cataratas, que son reversibles, y del glaucoma crónico. Dicho de otra forma: es una causa de ceguera que en muchos casos puede prevenirse o retrasarse significativamente si actuamos a tiempo.

Empecemos por el tamizaje, que es el punto de partida. Todo paciente diabético debe realizarse un fondo de ojo especializado al menos una vez al año. Si el resultado es normal, se puede espaciar el control a cada dos años. Pero en el momento en que aparece cualquier grado de retinopatía, el seguimiento se acorta: cada tres a seis meses, dependiendo de la severidad. Aquí hay un detalle técnico importante que el EUNACOM puede evaluar: no estamos hablando de cualquier fondo de ojo. No es el examen con el oftalmoscopio de cabecera. Es un examen especializado que requiere dilatación pupilar y una cámara fotográfica que captura la retina completa. Solo con ese procedimiento se puede hacer tamizaje, confirmar diagnóstico y estadificar la gravedad del daño.

La retinopatía diabética se clasifica en dos grandes etapas: la no proliferativa y la proliferativa.',
    ...
    '[]'::jsonb,
    '[{"pregunta":"¿Cuál es la secuencia correcta de las lesiones que aparecen en el fondo de ojo durante la progresión de la retinopatía diabética no proliferativa?\nA) Neovasos → microaneurismas → exudados algodonosos → exudados serosos amarillos.\nB) Exudados serosos amarillos → microaneurismas → exudados algodonosos (microinfartos blancos).\nC) Exudados algodonosos blancos → hemorragia vítrea → microaneurismas rojos.\nD) Microaneurismas rojos → neovasos → hemorragia vítrea → exudados serosos.\nE) Exudados serosos amarillos → neovasos → microaneurismas → exudados algodonosos.","respuesta":"Respuesta correcta: B — La secuencia de la retinopatía no proliferativa comienza con exudados serosos (plasma que fuga hacia la retina, visibles como manchas amarillas), luego se forman microaneurismas (dilataciones capilares, puntos rojos), que pueden romperse (microhemorragias) o trombosarse causando microinfartos de retina, que se ven como exudados algodonosos (manchas blancas, no amarillas). Los neovasos definen la transición a la etapa proliferativa."},{"pregunta":"¿Cuál es la frecuencia correcta del fondo de ojo de seguimiento y cuáles son las características técnicas del examen requerido para el tamizaje de retinopatía diabética?\nA) Cada 5 años en diabéticos sin retinopatía; puede realizarse con oftalmoscopio de mano sin dilatación pupilar.\nB) Anualmente en todo diabético; requiere dilatación pupilar y cámara fotográfica especializada. Con retinopatía presente, control cada 3-6 meses.\nC) Cada 2 años en todo diabético independientemente de si hay o no retinopatía; el oftalmoscopio de mano es suficiente.\nD) Solo cuando el paciente refiere síntomas visuales; el tamizaje asintomático no está indicado en diabéticos bien controlados.\nE) Anualmente solo en diabéticos tipo 1; los tipo 2 se tamizan cada 3 años por tener menor riesgo de retinopatía.","respuesta":"Respuesta correcta: B — Todo paciente diabético debe realizarse un fondo de ojo especializado anualmente. El examen requiere dilatación pupilar y cámara fotográfica que captura la retina completa; no es válido el oftalmoscopio de mano de cabecera. Si el resultado es normal, puede espaciarse a cada 2 años. Una vez detectada cualquier grado de retinopatía, el seguimiento se intensifica a cada 3-6 meses según la severidad."}]'::jsonb,
    NOW(),
    TRUE,
    FALSE  -- first 3 free preview
  ) ON CONFLICT (specialty_id, order_index)
...
que eso, voy a salvar los pie diabéticos que estén bien.',
    'El pie diabético es una de las complicaciones de la diabetes con mayor impacto en la vida cotidiana de los pacientes. Genera limitación funcional, deterioro psicológico y, en sus formas más avanzadas, conduce a amputaciones que cambian la vida para siempre. Y lo que más duele de esto es que es en gran medida prevenible. Si evaluamos bien la sensibilidad y la vascularización de los pies, y educamos al paciente sobre el cuidado cotidiano de sus extremidades, podemos evitar llegar a ese punto.

Comencemos por la definición. El pie diabético es cualquier pie de un paciente con diabetes que tenga una úlcera activa, o bien que tenga un alto riesgo de desarrollarla. Este segundo punto es importante: no es necesario que ya haya una herida. Un paciente con diabetes que tiene neuropatía periférica, piel seca con fisuras, deformidades articulares en los dedos y sensibilidad disminuida ya tiene pie diabético grado 0, aunque la piel todavía esté intacta. El riesgo ya está presente.

La causa es multifactorial, y hay tres pilares que siempre deben recordar: la neuropatía periférica, que hace que el paciente no sienta las heridas; la vasculopatía con isquemia, que hace que no cicatricen; y la inmunosupresión relativa de la diabetes crónica, que hace que se infecten. Cuando estos tres factores coexisten, una pequeña rozadura por un zapato nuevo puede convertirse, en semanas, en una úlcera profunda con osteomielitis.',
    ...
    '["Pie diabético: úlcera activa o alto riesgo de úlcera en paciente diabético. Causas: neuropatía, vasculopatía e inmunosupresión.","Clasificación grados 0-5: grado 0 (riesgo sin úlcera), grado 1 (úlcera superficial), grado 2 (tendones/músculos), grado 3 (absceso/osteomielitis), grado 4 (gangrena localizada), grado 5 (gangrena total).","Prevención: control metabólico, cuidado del calzado, podología, evaluación vascular y revascularización cuando hay isquemia."]'::jsonb,
    '[]'::jsonb,
    '[{"pregunta":"¿Cuál es el examen inicial de elección para evaluar compromiso óseo (osteomielitis) en un paciente con pie diabético grado 3, y cuándo se solicita la resonancia magnética?\nA) Resonancia magnética de inmediato, porque es el examen más sensible y evita los falsos negativos de la radiografía.\nB) Tomografía computada como examen inicial por su mayor resolución comparado con la radiografía convencional.\nC) Radiografía simple como examen inicial; la resonancia magnética se solicita si la clínica y la radiografía no son concluyentes para definir la extensión del compromiso óseo.\nD) Cintigrama óseo de tres fases como examen de primera línea, ya que puede detectar osteomielitis antes que cualquier otro método.\nE) El diagnóstico de osteomielitis siempre requiere biopsia ósea; las imágenes son solo orientadoras.","respuesta":"Respuesta correcta: C — El algoritmo de evaluación del compromiso óseo en pie diabético es: primero la clínica directa (si la sonda llega a hueso, hay osteomielitis sin necesidad de imágenes), luego radiografía simple (rápida, económica, disponible), y si no es concluyente, resonancia magnética (el examen más sensible). La RM no se solicita de primera línea por razones de costo y disponibilidad, y la radiografía frecuentemente ya es diagnóstica en estadios avanzados."},{"pregunta":"¿Cuál de los tres pilares fisiopatológicos del pie diabético explica por qué las úlceras se infectan con facilidad y tienen mala cicatrización?\nA) Solo la neuropatía explica ambas: la pérdida de sensibilidad hace que el paciente no note las heridas y no trate las infecciones.\nB) La vasculopatía (isquemia) explica la mala cicatrización al reducir el aporte de oxígeno y nutrientes; la inmunosupresión relativa de la diabetes explica la susceptibilidad a la infección.\nC) Solo la vasculopatía explica la mala cicatrización; la diabetes no afecta la función inmune de manera clínicamente relevante.\nD) La neuropatía es el único factor relevante; la vasculopatía solo importa cuando hay isquemia crítica con ausencia de pulsos.\nE) Los tres factores son interdependientes y equivalentes; no es posible atribuir una complicación a un pilar específico.","respuesta":"Respuesta correcta: B — Aunque los tres pilares son interdependientes, cada uno tiene un rol específico: la neuropatía hace que el paciente no sienta la herida (factor de inicio), la vasculopatía con isquemia compromete la cicatrización al reducir el aporte de oxígeno y nutrientes (factor de progresión), y la inmunosupresión relativa de la diabetes crónica hace que los gérmenes proliferen con menor resistencia del huésped (factor de infección). Los tres juntos explican por qué una rozadura mínima puede convertirse en una osteomielitis en semanas."}]'::jsonb,
    NOW(),
    TRUE,
    FALSE  -- first 3 free preview
  ) ON CONFLICT (specialty_id, order_index)
...
descomprimir quirúrgicamente y bueno eso fue todo de este tema un tema corto pero importante',
    'La neuropatía diabética es una complicación crónica que deben tener bien clara para el EUNACOM. Lo central aquí es conocer las distintas formas clínicas, porque el diagnóstico es fundamentalmente clínico, y saber diferenciarlas es lo que permitirá orientar el tratamiento de manera correcta.

Empecemos con la forma más frecuente: la neuropatía sensitiva distal simétrica, también llamada polineuropatía sensitiva. La característica principal es la disminución de la sensibilidad. Las modalidades más afectadas son la termalgésica, es decir la sensibilidad al dolor y a la temperatura, y la vibratoria. La distribución es distal y simétrica: parte en los pies, en distribución de calcetín, y si avanza puede comprometer también las manos, dando la distribución en guante y calcetín. Además de la afectación sensitiva, puede haber atrofia muscular y cutánea distal, porque el daño compromete al nervio periférico en su totalidad.

Esta pérdida de sensibilidad, especialmente la del dolor, es el mecanismo que conecta la neuropatía con el pie diabético. Pensemos en un carpintero de 59 años con diabetes tipo 2 de catorce años de evolución. Un día usa botas nuevas que le quedan un poco ajustadas. Normalmente cualquier persona notaría la incomodidad en pocas horas. Él no siente nada. Llega a casa con una ampolla rota en el dedo gordo izquierdo que no vio ni sintió en todo el día. Eso es la neuropatía sensitiva actuando como factor de riesgo para el pie diabético.',
...
que nos vemos.',
    'En esta cápsula revisamos las dos grandes emergencias hiperglicémicas de la diabetes: la cetoacidosis diabética y el síndrome hiperglicémico hiperosmolar. Ambos cuadros son conocidos en el lenguaje cotidiano como "coma diabético", pero ojo: ese término también se usa para la hipoglicemia severa, que es una entidad completamente diferente. No confundan los conceptos.

Empecemos por lo más básico: en qué tipo de diabetes predomina cada uno. La cetoacidosis diabética es característica de la diabetes tipo 1. Su fisiopatología parte de la ausencia absoluta de insulina, que lleva a la producción descontrolada de cuerpos cetónicos. El síndrome hiperglicémico hiperosmolar, en cambio, es propio de la diabetes tipo 2.

Analicemos la presentación clínica. La cetoacidosis suele debutar con síntomas digestivos: náuseas, vómitos y dolor abdominal. De hecho, es una causa reconocida de abdomen agudo de origen metabólico. Imaginen a una adolescente de 16 años con diabetes tipo 1 que llega a urgencias con dos días de vómitos, dolor abdominal difuso y sensación de sed intensa. Sus familiares creen que tiene una gastroenteritis. Sin embargo, al examinarla uno nota que está deshidratada, con mucosas secas, y que respira de una manera particular: lenta, muy profunda, regular. Eso es la respiración de Kussmaul. El organismo está intentando eliminar dióxido de carbono para compensar la acidosis metabólica y subir el pH. Al acercarse, se percibe un aliento con un olor dulzón, como a manzana o acetona. Ese es el aliento cetónico. Un hemoglucotest rápido confirma una glicemia de 380 miligramos por decilitro. La suma de estos elementos debe activar de inmediato la sospecha de cetoacidosis.',
    ...
    '[]'::jsonb,
    '[{"pregunta":"¿Cuáles son los criterios diagnósticos que permiten distinguir el síndrome hiperglicémico hiperosmolar (HGHO) de la cetoacidosis diabética (CAD)?\nA) El HGHO se diagnostica con glicemia > 250 mg/dL y pH < 7,3, igual que la CAD pero con mayor compromiso de conciencia.\nB) La CAD requiere glicemia > 600 mg/dL, cuerpos cetónicos y acidosis metabólica; el HGHO solo requiere glicemia > 250 mg/dL y osmolaridad > 300 mOsm/L.\nC) El HGHO requiere glicemia > 600 mg/dL y osmolaridad efectiva > 320 mOsm/L sin acidosis ni cetonemia significativas; la CAD requiere cetonemia/cetonuria, pH < 7,3 y glicemia > 250 mg/dL.\nD) Ambos cuadros son clínicamente idénticos; la única diferencia es el tipo de diabetes de base.\nE) La CAD se diagnostica solo con la clínica (aliento a acetona + Kussmaul); el HGHO requiere confirmación con osmolaridad calculada.","respuesta":"Respuesta correcta: C — El HGHO se define por glicemia > 600 mg/dL + osmolaridad efectiva > 320 mOsm/L (calculada como 2×Na + Glicemia/18), sin requerir acidosis ni cetonemia significativas. La CAD se define por el tríada: cetonemia/cetonuria + acidosis metabólica (pH < 7,3, bicarbonato bajo, anión gap > 12) + glicemia > 250 mg/dL. Pueden coexistir cuadros mixtos."}]'::jsonb,
    NOW(),
    TRUE,
    FALSE  -- first 3 free preview
  ) ON CONFLICT (specialty_id, order_index)
...
Y bueno, eso fue todo, que estén bien.',
    'Piensen en dos pacientes que ingresan a urgencias en el mismo turno nocturno. El primero es un hombre de 55 años, diabético tipo 2, que lleva tres días con diarrea profusa y no ha podido tomar ni sus medicamentos ni agua. Su señora lo trae porque desde la tarde está muy raro, no reconoce dónde está. Al examinarlo: presión arterial de 88 sobre 55, frecuencia cardíaca de 124, piel pastosa, ojos hundidos. La glicemia capilar no cabe en el glucómetro, sale "HI". En el laboratorio: glicemia de 980 miligramos por decilitro, osmolaridad calculada de 348 mOsm por kilo, pH de 7,34, bicarbonato de 20. Sin acidosis relevante. Es un síndrome hiperglicémico hiperosmolar clásico. La segunda paciente es una adolescente de 16 años, diabética tipo 1 diagnosticada hace dos años, que llegó por sus propios medios pero visiblemente angustiada: respira como si hubiera corrido una maratón, su aliento huele a acetona, lleva dos días olvidando ponerse la insulina. Glicemia 490, pH 7,12, bicarbonato 7, anión gap 26. Es una cetoacidosis diabética grave. Dos presentaciones muy distintas. Un tratamiento que sigue el mismo esquema. Aprendan ese esquema y van a saber manejar ambas.

El tratamiento de ambas emergencias se organiza en cuatro pilares. Memorícenlos como SIPB: Suero, Insulina, Potasio y Bicarbonato.

El primer pilar, y el más urgente, es la reposición de volumen con suero fisiológico. Estos pacientes pueden perder entre cinco y diez litros de agua libre por la diuresis osmótica que genera la hiperglicemia extrema. El hombre de 55 años que describí estaba en shock hipovolémico franco. Lo primero que se le pone, antes de cualquier examen y sin esperar ningún resultado de laboratorio, es suero fisiológico en bolo: un litro o 20 mL por kilo, a pasar tan rápido como la vía lo permita. Luego se mantiene una infusión de 20 mL por kilo por hora, ajustando con monitorización clínica o idealmente con un catéter venoso central. El objetivo inmediato es recuperar la presión arterial y bajar la frecuencia cardíaca. El suero fisiológico es lo único que no requiere esperar exámenes.',
...
más la etiología de las hipoglicemias. ¡Que estén bien!',
    'La hipoglicemia es uno de esos temas donde el EUNACOM pone trampas que se evitan fácilmente si entienden bien la fisiopatología. En esta cápsula vamos a ver la clínica y el tratamiento. En la siguiente, profundizaremos en las causas y el estudio etiológico.

Empecemos por la clínica, que se organiza en dos grupos de síntomas según el mecanismo que los genera.

El primer grupo son los síntomas simpáticomiméticos. Cuando la glicemia empieza a descender, el sistema nervioso autónomo detecta la amenaza y lanza una respuesta de alarma: libera adrenalina y activa el sistema simpático. Esto produce taquicardia, temblor, sudoración, inquietud y una sensación de malestar difuso. Son los síntomas más precoces y los más leves. Sirven de aviso para que el paciente actúe: come azúcar, toma un jugo, y el problema se resuelve antes de empeorar.',
    ...
    '[]'::jsonb,
    '[{"pregunta":"¿Cuáles son las tres condiciones de la tríada de Whipple que se deben cumplir para confirmar el diagnóstico de hipoglicemia?\nA) Glicemia < 60 mg/dL, síntomas compatibles y respuesta a glucosa IV o glucagón.\nB) Síntomas compatibles con hipoglicemia, glicemia baja objetivada en el momento de los síntomas, y resolución de los síntomas al elevar la glicemia con azúcar.\nC) Taquicardia, sudoración y temblor, cualquiera de los tres es suficiente para confirmar el diagnóstico.\nD) Síntomas neuroglucopénicos + glicemia < 50 mg/dL + respuesta a bicarbonato endovenoso.\nE) Antecedente de uso de insulina o sulfonilureas, síntomas compatibles y glicemia < 70 mg/dL.","respuesta":"Respuesta correcta: B — La tríada de Whipple exige que se cumplan simultáneamente: (1) síntomas compatibles con hipoglicemia, (2) glicemia objetivamente baja medida en el momento exacto de los síntomas, y (3) resolución de los síntomas al elevar la glicemia con azúcar. Si alguna de las tres condiciones falta, el diagnóstico no está confirmado, porque otras condiciones (feocromocitoma, hipertiroidismo, crisis de angustia) pueden simular los síntomas simpáticomiméticos con glicemias normales."}]'::jsonb,
    NOW(),
    TRUE,
    FALSE  -- first 3 free preview
  ) ON CONFLICT (specialty_id, order_index)
...
que estén bien',
    'Ya sabemos cómo reconocer y tratar una hipoglicemia. Ahora viene la pregunta del médico clínico: ¿por qué le está bajando el azúcar a este paciente? Esa es la pregunta que vamos a responder en esta cápsula, y es fundamental para el EUNACOM porque integra fisiopatología, clínica y laboratorio en un solo razonamiento.

La clasificación más útil divide las hipoglicemias en dos grandes grupos: las provocadas y las espontáneas.

Las hipoglicemias provocadas son las que tienen una causa farmacológica identificable. Las más frecuentes son las producidas por insulina exógena y por los hipoglicemiantes orales secretagogos, en especial las sulfonilureas como la glibenclamida, y también las metiglinidas, que actúan de manera similar estimulando la secreción pancreática de insulina. Dentro de las provocadas existe una distinción clínicamente importante. Están las que son reacciones adversas esperadas en el tratamiento de un diabético conocido, y están las hipoglicemias facticias: aquellas donde el paciente se está administrando insulina o hipoglicemiantes de manera oculta, sin declararlo. El problema de las facticias es que se presentan como si fueran espontáneas y generan un desafío diagnóstico real. Piensen en un técnico de enfermería de 34 años sin diabetes conocida que llega varias veces a urgencias con hipoglicemias inexplicables. Ese es un caso clásico de hipoglicemia facticia por insulina, que debuta como espontánea hasta que el laboratorio lo delata.',
...
nos vemos, que estén bien.',
    'El manejo de las dislipidemias es uno de esos temas donde el EUNACOM exige que entiendan la lógica del tratamiento, no solo que memoricen fármacos. Si entienden el razonamiento clínico, las respuestas se vuelven obvias. Vamos paso a paso.

Lo primero, y esto aplica siempre sin excepción, es el tratamiento no farmacológico. La dieta saludable y el ejercicio regular son la base del manejo de cualquier dislipidemia, independientemente del tipo o del riesgo cardiovascular. Pero hay matices según qué lípido está alterado.

En la hipercolesterolemia con LDL elevado, la clave dietética es reducir las grasas saturadas. No es lo mismo que reducir el colesterol de la dieta: son las grasas saturadas las que más estimulan la síntesis hepática de LDL. Y siempre hay que buscar causas secundarias. El hipotiroidismo es la causa secundaria más frecuente de LDL elevado, al punto que un hipotiroidismo subclínico no tratado puede ser responsable de una hipercolesterolemia que no responde bien al tratamiento estándar. Piensen en una mujer de 50 años con LDL de 175 que no baja con dieta estricta: vale la pena pedir una TSH antes de agregar una estatina.',
...
Que estén bien.',
    'Cada vez que un médico prescribe una estatina, tarde o temprano un paciente va a llegar a la consulta diciendo que le duelen los músculos. Y la pregunta siempre es la misma: ¿son las estatinas o es otra cosa? Esta cápsula les entrega el razonamiento para responder esa pregunta correctamente.

Antes de entrar al tema, una aclaración necesaria: las estatinas son medicamentos eficaces, seguros y con evidencia sólida de reducción de mortalidad cardiovascular. Las complicaciones musculares existen, pero son bastante infrecuentes. El problema no es que las estatinas sean peligrosas, sino que el miedo exagerado lleva a suspenderlas cuando no deberían suspenderse, privando al paciente de un beneficio cardiovascular real.

Las miopatías por estatinas se dividen en dos grandes grupos según su gravedad.',
...
los siguientes temas que estén bien',
    'Las dislipidemias genéticas son un tema que parece complejo pero que el EUNACOM evalúa desde un ángulo muy concreto: ¿saben reconocer en la clínica a un paciente que tiene una dislipidemia hereditaria? Si saben reconocer las señales de alerta, tienen el tema dominado.

La primera señal es el nivel de los lípidos. Hay valores que simplemente no se alcanzan por llevar una mala dieta o por tener resistencia a la insulina. Un LDL por encima de 500 miligramos por decilitro o unos triglicéridos que superan los 1.000 miligramos por decilitro no se explican por factores ambientales. Cuando ven esos números, piensen en genética antes de pensar en otra cosa.

La segunda señal es el patrón familiar. La mayoría de las dislipidemias genéticas siguen una transmisión autosómica dominante. Eso significa que con una sola copia del gen mutado el paciente ya desarrolla la enfermedad, y que hay una probabilidad alta de que parientes de primer grado también estén afectados. Cuando el paciente les cuenta que su madre falleció de un infarto a los 48 años, que su hermano mayor tuvo un stent a los 45, y que un tío murió de causa cardiovascular en la cincuentena, esa historia familiar es una señal de alerta mayor. No hace falta que los tres factores estén presentes simultáneamente: cualquiera de ellos debe empujar a buscar la causa.',
    ...
    '[]'::jsonb,
    '[{"pregunta":"¿Cuál de las siguientes situaciones clínicas debe hacer sospechar una dislipidemia de origen genético?\nA) Un hombre de 65 años con LDL de 140 mg/dL, triglicéridos 200 mg/dL y arco corneal bilateral visible.\nB) Una mujer de 55 años con HDL de 25 mg/dL, triglicéridos 450 mg/dL y sobrepeso importante.\nC) Un hombre de 38 años con LDL de 520 mg/dL, xantomas en tendones de Aquiles e historia de infarto paterno a los 42 años.\nD) Una mujer de 70 años con LDL de 180 mg/dL, hipotiroidismo conocido en tratamiento y xantelasmas en párpados.\nE) Un hombre de 50 años con triglicéridos de 600 mg/dL, consumo diario de alcohol y LDL normal.","respuesta":"Respuesta correcta: C — El LDL de 520 mg/dL supera ampliamente cualquier valor alcanzable por causas adquiridas (dieta, sedentarismo). Los xantomas tendinosos (tendón de Aquiles) en un adulto joven son prácticamente patognomónicos de hipercolesterolemia familiar. El infarto paterno a los 42 años confirma historia familiar de enfermedad cardiovascular precoz. Las demás opciones tienen explicaciones adquiridas más probables: el arco corneal en 65 años es etario (no patológico); la mujer de 55 tiene perfil de síndrome metabólico; el hipotiroidismo explica el LDL elevado; y el alcohol explica la hipertrigliceridemia."},{"pregunta":"¿Cuál es el esquema de tratamiento farmacológico de primera línea para la hipercolesterolemia familiar heterocigota, y por qué difiere del tratamiento estándar de la dislipidemia adquirida?\nA) Estatina en dosis estándar (ej. atorvastatina 20 mg/día) sola; es suficiente para lograr el objetivo de LDL en la mayoría de los pacientes con hipercolesterolemia familiar.\nB) Solo cambios de estilo de vida y dieta estricta durante 6 meses antes de considerar fármacos, igual que en la dislipidemia adquirida.\nC) Estatina de alta intensidad en dosis máximas (atorvastatina 80 mg/día) combinada con ezetimibe desde el inicio; la magnitud del LDL genético requiere una reducción agresiva que una estatina sola habitualmente no logra.\nD) Fibratos de primera línea porque el problema genético es principalmente de triglicéridos, no de LDL.\nE) Niacina en dosis altas como primera línea por su capacidad de reducir el LDL genético de manera específica.","respuesta":"Respuesta correcta: C — La hipercolesterolemia familiar tiene LDL tan elevado (frecuentemente 250-500 mg/dL) que una estatina sola a dosis estándar es insuficiente para alcanzar el objetivo. Se requiere la estatina más potente disponible en dosis máximas (atorvastatina 80 mg/día) combinada con ezetimibe desde el inicio. En casos de hipercolesterolemia familiar homocigota (LDL > 500-800 mg/dL), puede ser necesario agregar inhibidores de PCSK9. Los fibratos (opción D) son para hipertrigliceridemia, no para LDL elevado. La niacina (opción E) no tiene beneficio cardiovascular demostrado claro."}]'::jsonb,
    NOW(),
    TRUE,
    FALSE  -- first 3 free preview
  ) ON CONFLICT (specialty_id, order_index)
